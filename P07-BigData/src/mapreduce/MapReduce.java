...
public class MapReduce {
    public static ArrayList<Document> map(ArrayList<Document> friensList){
        ArrayList<Document> mapResult = new  ArrayList<>();
        friensList.stream().map((personFriend) -> {
    ...
    public  static Map<ArrayList, ArrayList> reduce (Map<ArrayList,
            ArrayList<ArrayList>> groupReslt){
        Map<ArrayList, ArrayList> reduceResult = new HashMap<>();
        
        groupReslt.entrySet().forEach((kv) -> {
